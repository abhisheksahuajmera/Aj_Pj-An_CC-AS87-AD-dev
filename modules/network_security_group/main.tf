resource "azurerm_network_security_group" "azurerm_network_security_grouptg" {
  name                = local.name
...
resource "azurerm_subnet_network_security_group_association" "azurerm_subnet_network_security_group_associationtg" {  
  subnet_id                 = "${var.subnet_id}"
  network_security_group_id = azurerm_network_security_group.azurerm_network_security_grouptg.id
}